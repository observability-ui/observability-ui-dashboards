import { Chart, ChartGroup, ChartLine, ChartVoronoiContainer } from '@patternfly/react-charts'; // eslint-disable-line @typescript-eslint/no-unused-vars
...
export const Panel = (props: PanelProps) => {
    ...
    const [response, setResponse] = React.useState({} as MetricsData); // eslint-disable-line @typescript-eslint/no-unused-vars
